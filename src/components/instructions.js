    ...
    this.setState({
      content: (
        <div>
          ...
          <br></br>
          <p>1. You can use any single device including personal computers, laptops, tablets or smartphones to login to the online platform multiple times. Multiple devices are not
allowed.</p>
          <p>2. A stable internet connection is recommended throughout the competition since the
organizing committee is not responsible for any connectivity issues.</p>
          ...
          <br></br>
          <p>1. Click on the <em><strong>Test Round</strong></em> button below the countdown timer. You will be redirected to a login page.</p>
          <p>2. Enter the given username <em>(eg: jr0001@umora.lk)</em>  with the relevant password to enter the competition.</p>
          <p>
            3. if you have logged early, you will be redirected to a page that says you to wait until the competition begins. Otherwise, you will be directly sent to the Questions dashboard. Your timer will start from the quiz time informed to you. 
          </p>
          <p>
            4. On the bottom, there are <em><strong>Prev</strong></em> and <em><strong>Next</strong></em> buttons to switch between concurrent questions. The <em><strong>Flag</strong></em> button can be used to flag any important question the user may intend to refer later.
          </p>
          <img alt="Prev Next Flag Buttons" className="insbottom" src={PrevNextFlag}></img><br></br><br></br>
          ...
          <img alt="Dashboard Colors" className="insDashClrs" src={QuestionColors}></img><br></br><br></br>
          ...
          <p>8. The <em>Next</em> button of the last question is the <em><strong>Submit</strong></em> button. When you click the <em>Submit</em> button you will be asked to confirm the submission. You may <em><strong>Submit and Leave</strong></em>if you are confident with your answers. Otherwise click on <em><strong>Go Back</strong></em> button and re-check before submission. You will not be given any change to log back in once you click <em><strong>Submit and Leave</strong></em> button.</p>
          <img alt="Dashboard Colors" className="instructImages" src={Submitwindow}></img><br></br><br></br>
      ...
      content: (
        <div>
          ...
          <table className="instructTable">
            <tr><th>Category</th><th>Correct Answer</th><th>No Answer</th><th>Wrong Answer</th></tr>
            <tr><th>Easy</th><td>2</td><td>0</td><td>-1</td></tr>
            <tr><th>Medium</th><td>3</td><td>0</td><td>-1</td></tr>
            <tr><th>Hard</th><td>5</td><td>0</td><td>-2</td></tr>
          </table><br></br>
          <p>&#9679; 10 percent of the total number of participants selected based on a cutoff mark will advance
to the second round. The list of selected participants will be displayed exclusively on the
official Facebook page of Electronic Club of the Department of Electronic and 
Telecommunication Engineering of University of Moratuwa<a href="https://www.facebook.com/uom.eclub"></a></p>
          ...
          <p>&#9679; The platform will be open for the practice round on 25th of June from 1400h to 2200h for
all the participants. The time for one login will run with a timer of 60 minutes. You will
be logged out from the session once the 60 minutes is over. You can login again for
another session and repeat the procedures until 2200h.</p>
          <br></br>
          <br></br>
