...
class Instruction extends Component{
    ...
    platlevel = () => {
        ...
        <div>
            ...
            <p>3. On the bottom, there are prev and next buttons to switch between concurrent questions. The flag button can be used to flag any important   question the user may intend to refer later.</p>
            ...
            <p style={{paddingLeft:'4%'}}> &#9679; <b>Flagged questions - Red</b></p>
            <p style={{paddingLeft:'4%'}}> &#9679; <b>Unanswered questions - White</b></p>
            <p style={{paddingLeft:'4%'}}> &#9679; <b>Answered questions - Blue</b></p>
    ...
    render() {
        return (
            <Fragment>
                ...
                <section>       
                        <Row>
                            <Col><button className='button' onClick={this.platlevel}> Platform Guidelines</button></Col>
                            <Col><button className='button' onClick={this.instruct}> Competition Rules</button></Col>
                        </Row>
                        <br/>    
                        {this.state.content}  
                </section>
